...
public class ultrasound extends JFrame implements ActionListener
{
	//JFrame frame;
	
	JComboBox ultrasoundbox;
//	JComboBox dates;
//	JComboBox years;
...
//		String[] date = {"100","50","20",""};
		String[] us = {"US K.U.B by Dr Faisal",
							"US K.U.B by Dr Saad",
							"US K.U.B by Dr Furqan",
							"US K.U.B by Dr Faraz",
							"US K.U.B by Dr Noor",
							"US F.W.B by Dr Rahila",
							"US F.W.B by Dr Muskan",
							"US F.W.B by Dr Ayesha",
							"US F.W.B by Dr Ruksana",
							"US F.W.B by Dr Sadaf"};
...
//		
		ultrasoundbox = new JComboBox(us);
		ultrasoundbox.setPreferredSize(new Dimension(90,20));
 		ultrasoundbox.addActionListener(this);
		ultrasoundbox.setEditable(true);
		ultrasoundbox.setBounds(120, 380, 120, 20);
...
//		shift.setBounds(600, 300, 200, 50);
		...
		ultrasound.setFont(new Font("Consolas",Font.BOLD,15));
		ultrasound.setBounds(0, 370, 100, 50);
...
//		this.add(b4);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(e.getSource()==ultrasoundbox )
		{
			t9.setText(ultrasoundbox.getSelectedItem()+"");
