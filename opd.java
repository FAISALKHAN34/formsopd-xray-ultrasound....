...
public class opd extends JFrame implements ActionListener
{
	//JFrame frame;
...
//	JComboBox years;
	...
	opd()
	{
		...
		String[] drfs = {"DR Saad - 100","Dr Furqan - 20","Dr Faisal - 50","Dr Ali - 100","Dr Faraz"};
		...
		drf = new JComboBox(drfs);
 		drf.setPreferredSize(new Dimension(90,20));
		drf.addActionListener(this);
		drf.setEditable(true);
		drf.setBounds(120, 380, 120, 20);
...
//		
		...
		opd = new JLabel();
		opd.setText("Dr/Fees");
		opd.setFont(new Font("Consolas",Font.BOLD,15));
		opd.setBounds(0, 370, 100, 50);
...
//		t8.setFont(new Font("Consolas",Font.BOLD,25));
		...
		t9 = new JTextField();
		t9.setBounds(270, 350, 250, 30);
		t9.setFont(new Font("Consolas",Font.BOLD,25));
		...
		xray = new JButton("XRAY");
		xray.setBounds(400, 50, 100, 50);
...
//		b4.addActionListener(this);
		...
		//this.add(cashier);
		this.add(opd);
		this.add(t1); //patient name
		this.add(t2); // father name
		this.add(t3); //phone
		this.add(t4); //gender
		this.add(t5);//age
		//this.add(t6);//dist
...
//		}
		if(e.getSource()==drf )
		{
			t9.setText(drf.getSelectedItem()+"");
